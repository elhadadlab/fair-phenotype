...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (195585,194684,195575,201606)

) I
) C UNION ALL 
SELECT 1 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (262,9201)
...
(
  select vo.* 
  FROM ohdsi_cumc_2021q1r2.dbo.VISIT_OCCURRENCE vo
JOIN #Codesets codesets on ((vo.visit_concept_id = codesets.concept_id and codesets.codeset_id = 1))
) C
JOIN ohdsi_cumc_2021q1r2.dbo.PERSON P on C.person_id = P.person_id
...
DELETE FROM ohdsi_cumc_2021q1r2.results.crohns_example where cohort_definition_id = 22223;
INSERT INTO ohdsi_cumc_2021q1r2.results.crohns_example (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 22223 as cohort_definition_id, person_id, start_date, end_date 
