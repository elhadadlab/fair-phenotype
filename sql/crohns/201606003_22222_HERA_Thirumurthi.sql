CREATE TABLE ohdsi_cumc_2021q1r2.results.crohns_example (
...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (201606,46269889,37111373,4055019)
UNION  select c.concept_id
  ...
  and ca.ancestor_concept_id in (201606,46269889,37111373,4055019)
...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (46269999)
UNION  select c.concept_id
  from ohdsi_cumc_2021q1r2.dbo.CONCEPT c
  join ohdsi_cumc_2021q1r2.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (46269999)
  and c.invalid_reason is null
...
DELETE FROM ohdsi_cumc_2021q1r2.results.crohns_example where cohort_definition_id = 22222;
INSERT INTO ohdsi_cumc_2021q1r2.results.crohns_example (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
select 22222 as cohort_definition_id, person_id, start_date, end_date 
