...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (19122121,1517998,1516976,1502905,1513876,1531601,1544838,1567198,1550023)
...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (1530014,1597756,1502809,1594973,1560171,1559684,1516766,1502826,1503297,1547504,1525215,1515249,1529331,1510202,1580747,1583722)
UNION  select c.concept_id
  from ohdsi_cumc_2021q1r2.dbo.CONCEPT c
  join ohdsi_cumc_2021q1r2.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (3004410,3005673,3003309,3007263)
UNION  select c.concept_id
  from ohdsi_cumc_2021q1r2.dbo.CONCEPT c
  join ohdsi_cumc_2021q1r2.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (3000483,3004501)
UNION  select c.concept_id
  from ohdsi_cumc_2021q1r2.dbo.CONCEPT c
  join ohdsi_cumc_2021q1r2.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (3037110)
UNION  select c.concept_id
  from ohdsi_cumc_2021q1r2.dbo.CONCEPT c
  join ohdsi_cumc_2021q1r2.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (42538169,377821,443592,201531,439770,318712,200687,201254,40484648,443412)
UNION  select c.concept_id
  from ohdsi_cumc_2021q1r2.dbo.CONCEPT c
  join ohdsi_cumc_2021q1r2.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
( 
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (443735,443732,443767,192279,376065,443729,201826)
UNION  select c.concept_id
  from ohdsi_cumc_2021q1r2.dbo.CONCEPT c
  join ohdsi_cumc_2021q1r2.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
LEFT JOIN
(
  select concept_id from ohdsi_cumc_2021q1r2.dbo.CONCEPT where concept_id in (4225656,435216,37016355,201531,4228112,4224254,200687,4227210,201254,4295011,376979,195771)
UNION  select c.concept_id
  from ohdsi_cumc_2021q1r2.dbo.CONCEPT c
  join ohdsi_cumc_2021q1r2.dbo.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
DELETE FROM ohdsi_cumc_2021q1r2.results.diabetes_example where cohort_definition_id = 33335;
...
select 33335 as cohort_definition_id, person_id, start_date, end_date 
